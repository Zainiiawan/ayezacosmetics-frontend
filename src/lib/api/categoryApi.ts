...
export const categoryApi = {
  ...
  create: async (data: { name: string; description?: string; isActive?: boolean; image?: { url: string; publicId: string; alt?: string } }): Promise<Category> => {
  ...
  update: async (
    id: string,
    data: { name?: string; description?: string; isActive?: boolean; image?: { url: string; publicId: string; alt?: string } }
  ): Promise<Category> => {
